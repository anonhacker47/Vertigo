<template>
  <div class="relative h-screen flex justify-center items-center overflow-hidden">
    ...
    <img src="../assets/logo.svg" alt="Background Logo"
      class="absolute inset-0 object-cover filter blur-sm opacity-10">
    ...
    <PanelCardItem class="relative z-10">
      ...
      <form @submit.prevent="register" class="flex flex-col space-y-4 mt-6">
        ...
        <div>
          <label for="passwordConfirm" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm
            Password</label>
      ...
      <p class="text-sm text-center font-light text-gray-500 dark:text-gray-400 mt-4">
