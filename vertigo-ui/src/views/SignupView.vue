  ...
  <div class="relative h-screen flex justify-center items-center overflow-hidden">
    ...
    <PanelCardItem class="relative z-10">
      ...
      <form @submit.prevent="register" class="flex flex-col space-y-4 mt-6">
        ...
        <button type="submit"
          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full py-2.5 text-center ">
          Sign up
        </button>
